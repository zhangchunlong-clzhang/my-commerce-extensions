 ...
 */
declare function createAdobeIoEventsApiClient(params: IoEventsHttpClientParams): _$_adobe_aio_commerce_lib_api0.ApiClientRecord<AdobeIoEventsHttpClient, {
  getAllRegistrationsByConsumerOrg(httpClient: AdobeIoEventsHttpClient, params: GetAllRegistrationsByConsumerOrgParams, fetchOptions?: _$ky.Options): Promise<IoEventRegistrationPaginatedResponse>;
  getAllRegistrations(httpClient: AdobeIoEventsHttpClient, params: GetAllRegistrationsParams, fetchOptions?: _$ky.Options): Promise<IoEventRegistrationManyResponse>;
  getRegistrationById(httpClient: AdobeIoEventsHttpClient, params: GetRegistrationByIdParams, fetchOptions?: _$ky.Options): Promise<IoEventRegistrationHalModel>;
  createRegistration(httpClient: AdobeIoEventsHttpClient, params: CreateRegistrationParams, fetchOptions?: _$ky.Options): Promise<IoEventRegistrationHalModel>;
  updateRegistration(httpClient: AdobeIoEventsHttpClient, params: UpdateRegistrationParams, fetchOptions?: _$ky.Options): Promise<IoEventRegistrationHalModel>;
  deleteRegistration(httpClient: AdobeIoEventsHttpClient, params: DeleteRegistrationParams, fetchOptions?: _$ky.Options): Promise<void>;
  getAllCommerceEventProviders(httpClient: AdobeIoEventsHttpClient, params: _$type_fest0.OmitDeep<EventProviderListAllParams, "filterBy.providerType">, fetchOptions?: _$ky.Options): Promise<IoEventProviderManyResponse>;
  getAll3rdPartyCustomEventProviders(httpClient: AdobeIoEventsHttpClient, params: _$type_fest0.OmitDeep<EventProviderListAllParams, "filterBy.providerType">, fetchOptions?: _$ky.Options): Promise<IoEventProviderManyResponse>;
  createCommerceEventProvider(httpClient: AdobeIoEventsHttpClient, params: _$type_fest0.OmitDeep<EventProviderCreateParams, "providerType">, fetchOptions?: _$ky.Options): Promise<IoEventProviderHalModel>;
  create3rdPartyCustomEventProvider(httpClient: AdobeIoEventsHttpClient, params: _$type_fest0.OmitDeep<EventProviderCreateParams, "providerType">, fetchOptions?: _$ky.Options): Promise<IoEventProviderHalModel>;
  getAllEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: GetAllEventMetadataForProviderParams, fetchOptions?: _$ky.Options): Promise<IoEventMetadataManyResponse>;
  getEventMetadataForEventAndProvider(httpClient: AdobeIoEventsHttpClient, params: GetEventMetadataForEventAndProviderParams, fetchOptions?: _$ky.Options): Promise<IoEventMetadataHalModel>;
  createEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: CreateEventMetadataForProviderParams, fetchOptions?: _$ky.Options): Promise<IoEventMetadataHalModel>;
  deleteEventMetadataForProvider(httpClient: AdobeIoEventsHttpClient, params: DeleteEventMetadataForProviderParams, fetchOptions?: _$ky.Options): Promise<void>;
  getAllEventProviders(httpClient: AdobeIoEventsHttpClient, params: EventProviderListAllParams, fetchOptions?: _$ky.Options): Promise<IoEventProviderManyResponse>;
  getEventProviderById(httpClient: AdobeIoEventsHttpClient, params: EventProviderGetByIdParams, fetchOptions?: _$ky.Options): Promise<IoEventProviderHalModel>;
  createEventProvider(httpClient: AdobeIoEventsHttpClient, params: EventProviderCreateParams, fetchOptions?: _$ky.Options): Promise<IoEventProviderHalModel>;
  deleteEventProvider(httpClient: AdobeIoEventsHttpClient, params: EventProviderDeleteParams, fetchOptions?: _$ky.Options): Promise<void>;
}>;
/**
 ...
 */
declare function createCustomAdobeIoEventsApiClient<TFunctions extends Record<string, ApiFunction<AdobeIoEventsHttpClient, any[], any>>>(params: IoEventsHttpClientParams, functions: TFunctions): _$_adobe_aio_commerce_lib_api0.ApiClientRecord<AdobeIoEventsHttpClient, TFunctions>;
//#endregion
