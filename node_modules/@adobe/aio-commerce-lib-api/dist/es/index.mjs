...
import { n as buildIntegrationAuthBeforeRequestHook, r as isAuthProvider, t as buildImsAuthBeforeRequestHook } from "./hooks-BrkZpXTw.mjs";
...
function buildCommerceHttpClientPaaS(params) {
	...
	return optionallyExtendKy(ky.create({
