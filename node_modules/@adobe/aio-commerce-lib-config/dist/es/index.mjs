...
import { i as validateEncryptionKey, n as encrypt, r as generateEncryptionKey, t as decrypt } from "./encryption-OPvQpZNj.mjs";
...
function deriveScopeFromArgs(args, tree) {
	if (args.length === 2) return deriveScopeFromCodeAndLevel(args[0], args[1], tree);
	if (args.length === 1) {
		const arg = args[0];
		try {
...
//#endregion
export { SchemaBusinessConfig, byCode, byCodeAndLevel, byScopeId, generateEncryptionKey, getConfiguration, getConfigurationByKey, getScopeTree, initialize, setConfiguration, setCustomScopeTree, syncCommerceScopes, unsyncCommerceScopes, validateEncryptionKey };